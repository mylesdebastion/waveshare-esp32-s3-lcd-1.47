/**
 * @file wifi_config.h
 * @brief WiFi Configuration (Private - Not Committed to Git)
 */
...
// WLED Configuration
#define WLED_DEFAULT_PRESET 1       // Preset ID to trigger (1 = typically red pulse/fire)
#define WLED_ALARM_DURATION 80      // Duration in deciseconds (80 = 8 seconds)
